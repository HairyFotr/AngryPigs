...
class Branch(var parent:Branch) extends Properties {
    var (diffVec,rootVec) = (new Vec3, new Vec3)
    def destVec = rootVec+diffVec;
...
class ModelLink(m1:BasicModel, m2:BasicModel, var vector:Vec3=new Vec3, var vector2:Vec3=new Vec3) {
