...
Igra v principu deluje povsod, kjer je podprt LWJGL, a je skripta bashbeans za prevajanje in poganjanje napisana v bash-u. Torej deluje na Linux in MacOS, na Windows pa deluje v Cygwin bashu.\pa

Najprej je potrebno naložiti Scalo verzije 2.8 ali 2.9 z \inline{\url{http://www.scala-lang.org/downloads}}. Tudi ta korak bi bilo mogoče preskočiti, če bi imeli boljšo skripto in Scalino .jar datoteko v classpathu.

Nato poženemo bashbeans z zastavico -r (Run):
\inliney{$ ./bashbeans -r}
